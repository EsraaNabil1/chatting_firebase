...
class _chatState extends State<chat> {
  ...
  Widget build(BuildContext context) {
    ...
    width: 60,
    child: const Image(
    image: AssetImage("images/tameni.png"),
    fit: BoxFit.contain,
    ),
    ),
    ),
                  ...
                  children: [
                    //chat1("",Colors.transparent),
                     Container(color: Colors.teal.shade50,
                      child: chat1("",Colors.transparent)),
                    //chat1("",Colors.transparent),
                    //chat1("",Colors.transparent),
                    //chat1("",Colors.transparent),
                    //chat1("",Colors.transparent),
       ...
       Container(
         ...
         decoration: BoxDecoration(
             borderRadius: BorderRadius.circular(40),
              image: DecorationImage(image: AssetImage("images/male doctor.jpg"),fit: BoxFit.cover)
